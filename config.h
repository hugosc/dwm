...
static const Key keys[] = {
    ...
    {MODKEY,
     ...
     {.v =
          (const char *[]){
              "/home/croc/.config/scripts/shortcuts-menus/cliphist", NULL}}},
    {MODKEY,
     XK_c,
     spawn,
     {.v = (const char *[]){"/bin/cliphist", "store", NULL}}},
    {MODKEY | ShiftMask,
     XK_a,
     spawn,
    ...
    {MODKEY | ShiftMask,
     XK_r,
     spawn,
     {.v = (const char *[]){"/home/croc/.config/scripts/screenrecord", "toggle",
                            NULL}}},
    {MODKEY | ShiftMask,
     XK_grave,
     spawn,
    ...
    {MODKEY | ShiftMask, XK_w, spawn,
     SHCMD("/home/croc/.config/scripts/images-photos-wallpapers/"
           "fzfub-wallpapermenu")},
    ...
    {MODKEY | ShiftMask,
     XK_F3,
     spawn,
     {.v = (const char *[]){"phototransfer", NULL}}},
