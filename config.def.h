...
static const Key keys[] = {
    ...
    /* other bindings */
    {MODKEY, XK_F12, spawn, SHCMD("playerctl -p ncspot next")},
    {MODKEY, XK_F11, spawn, SHCMD("playerctl -p ncspot play-pause")},
    {MODKEY | ShiftMask, XK_F11, spawn, SHCMD("playerctl play-pause")},
    {MODKEY, XK_F10, spawn, SHCMD("playerctl -p ncspot previous")},
